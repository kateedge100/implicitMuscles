...
SOURCES       = src/main.cpp \
		...
		src/implicitoctree.cpp moc/moc_MainWindow.cpp \
...
obj/implicitoctree.o: src/implicitoctree.cpp include/implicitoctree.h \
		include/abstractOctree.h \
		../glm/glm.hpp \
		../glm/detail/_fixes.hpp \
		../glm/fwd.hpp \
		...
		/opt/Qt5.9.0/5.9/gcc_64/include/QtGui/QResizeEvent \
		/opt/Qt5.9.0/5.9/gcc_64/include/QtCore/QEvent
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/implicitoctree.o src/implicitoctree.cpp

...
public:
    ...
    //----------------------------------------------------------------------------------------------------------------------
    float pointToTriangleDistance(glm::vec3 pos, glm::vec3 v1, glm::vec3 v2, glm::vec3 v3);
    //----------------------------------------------------------------------------------------------------------------------
    float region0();
    //----------------------------------------------------------------------------------------------------------------------
    float region1(float s, float t, float a, float b, float c, float d, float e);
    //----------------------------------------------------------------------------------------------------------------------
    float region2(float s, float t, float c, float e);
    //----------------------------------------------------------------------------------------------------------------------
    float region3();
    //----------------------------------------------------------------------------------------------------------------------
    float region4();
